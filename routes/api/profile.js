...
router.post(
  ...
  async (req, res) => {
    ...
    if (skills) {
      // function below takes the comma-separated skills and turns them into an array
      // the map method here trims the spaces around each skill, if they exist
      profileFields.skills = skills.split(",").map(skill => skill.trim());
    }

    // building the 'social' object
    ...
    try {
      ...
      // create a new profile if not existent
...
router.put(
  ...
  async (req, res) => {
    ...
    const {
      ...
      company,
      location,
      // dates should be in ISOD format mm-dd-yyyy
      from,
      to,
      current,
      description
    ...
    const newEdu = { title, company, location, from, to, current, description };
